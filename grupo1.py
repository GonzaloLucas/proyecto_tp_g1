...
def DiccEspecialidades():
    ...
    try:
        especialidades = open('especialidades.json', 'w')
...
try:
    especialidades = open('especialidades.json', 'r')
    especialidades = json.load(especialidades)
